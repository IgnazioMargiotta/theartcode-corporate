      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-4 py-8">
        ...
        <div className="md:w-4/6 flex items-center justify-center">
          <div className="text-center">
            Vibra Studio - Via Fausto Coppi, 8/a 43122 Parma - P.IVA&nbsp;02949510347 <Link href="https://www.iubenda.com/privacy-policy/40428943/legal" className="underline" target="_blank" title="Cookie Policy">Cookie&nbsp;Policy</Link><br /><Link href="mailto:info@vibra.studio" className="font-normal" title="info@vibra.studio">info@vibra.studio</Link> &nbsp; <Link href="tel:+393518015772" className="font-normal" title="+39 351 801 5772">+39 351 801 5772</Link>
          </div>
        </div>
